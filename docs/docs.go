        ...
        "/v1/products/admin/update-product-variant": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Use as primary data (ถ้าเลือกเป็น true varaint ที่เหลือจะปรับเป็น false)",
        ...
        "/v1/products/create-stock": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Size remark (ถ้าเลือกไซส์เป็น other บังคับว่าต้องใส่ size remark ด้วย)",
                        "name": "size_remark",
                        "in": "formData"
                    },
                    {
